...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="b3740a8a-377f-42c5-a8de-fb5acb6f8043"
                type="wpfhost"
                hostedType="Addons\super design\super design.dll,super_design.ControlUI"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="b3740a8a-377f-42c5-a8de-fb5acb6f8043"/>
        </container>
